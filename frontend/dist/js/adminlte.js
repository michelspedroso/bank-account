...
(function (global, factory) {
  ...
  async function signup(payload, type = 'POST') {
    return request(`/user/signup`, type, payload);
  }
  async function signin(payload, type = 'POST') {
  ...
  async function getAccountTypes(payload, type = 'GET') {
    return request(`/account/types`, type, payload);
  }
  async function getAccounts(type = 'GET', params = {}) {
    return request('/account', type, params);
  }
  async function createAccount(params = {}, type = 'POST') {
    return request('/account', type, params);
  }
  async function applyDeposit(payload = {}, type = 'POST') {
    return request('/account/deposit', type, payload);
  }
  async function applyRefund(payload = {}, type = 'POST') {
